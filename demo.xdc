...
set_property PACKAGE_PIN E19 [get_ports {ForwardA}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ForwardA}]
set_property PACKAGE_PIN U19 [get_ports {ForwardB}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ForwardB}]
set_property PACKAGE_PIN V19 [get_ports {BranchTakenE}]
	set_property IOSTANDARD LVCMOS33 [get_ports {BranchTakenE}]
set_property PACKAGE_PIN W18 [get_ports {RegWriteW}]
